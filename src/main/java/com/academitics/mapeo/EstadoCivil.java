 ...
 */
@Entity
@Table(name = "estado_civil", catalog = "academitics")
public class EstadoCivil implements java.io.Serializable {
	...
	public EstadoCivil(Integer sucursal, Boolean elminado, String nombre,
			String derscripcion, Date fechaAdicion, Date fechaModificacion,
